...
public class JwtUtil {
    ...
    private Boolean isTokenExpiredII(String token) {
        return extractExpiration(token).before(new Date());
    }

    public String generateTokenI(UserDetails userDetails) {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        return (username.equals(userDetails.getUsername()) && !isTokenExpiredII(token));
    }
